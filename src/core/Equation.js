...
export default class Equation {
   ...
   * @param {string} solvent - Label of the solvent.
   * @returns {Equation} A new equation that does not include the solvent.
   */
  withSolvent(solvent) {
    let eq = {};
    const comp = this._eq.components;
    const formed = this._eq.formed;
